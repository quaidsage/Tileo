...
export function drawElementInfo(i: number, j: number, e: MouseEvent, currentElementInfo: HTMLDivElement): void {
    ...
    if (element) {
        ...
        let elementDetails = document.getElementById('element-details-menu') as HTMLDivElement;
        ...
        element.behaviours.forEach(behaviour => {
            switch(behaviour.constructor.name) {
                ...
                case 'GasMove':
                    ...
                    break;
                case 'Burning':
                    life = ((behaviour as Burning).life).toFixed(2);
                    break;
                case 'Life':
                    life = ((behaviour as Life).life).toFixed(2);
                    break;
                default:
                    break;
            }
